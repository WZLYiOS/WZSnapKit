...
class HorizontalViewController: UIViewController {
    ...
    private func example1() {
        ...
        btnArr.snp.distributeViewsAlong(axisType: .horizontal, fixedItemSpacing: 20, edgeInset: UIEdgeInsets(top: 10, left: 20, bottom: 0, right: 20), fixedItemLength: 70, topConstrainView: label)
...
//        }
    ...
    private func example2() {
        ...
        var btnArr: [UIButton] = []
        var textArr = ["button 1", "button 123", "button 123456789", "adadadadad", "adadadadad"]
...
//                make.width.equalTo((i + 1) * 40)
        ...
        btnArr.snp.distributeViewsAlong(axisType: .horizontal, fixedItemSpacing: 20, edgeInset: UIEdgeInsets(top: 360, left: 20, bottom: 0, right: 20))
    }
