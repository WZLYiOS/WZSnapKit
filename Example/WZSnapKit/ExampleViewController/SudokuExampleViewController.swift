...
//            make.height.equalTo(200)
        ...
        views.snp.distributeSudokuViews(verticalSpacing: 10, horizontalSpacing: 10, warpCount: 3, edgeInset: UIEdgeInsets(top: 10, left: 10, bottom: 10, right: 10), itemHeight: 50, itemWidth: 50, topConstrainView: label)
    }
    ...
    private func example2() {
        ...
        views.snp.distributeSudokuViews(verticalSpacing: 10, horizontalSpacing: 30, warpCount: 3, edgeInset: UIEdgeInsets(top: 10, left: 10, bottom: 10, right: 10), itemHeight: 20, topConstrainView: label)
    }
